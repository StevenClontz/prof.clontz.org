...
\begin{itemize}
  ...
  \item I previously received a mark of \issuesMark{} or better for this standard.
    \(\square\)
  \item This standard is not scheduled to appear on today's quiz.
    \(\square\)
  \item I am submitting at most four requests today. 
    \(\square\)
  \item I have attached three correctly worked exercises related to this standard.
    \(\square\)
\end{itemize}

If you meet all these requirements, bring this form to class.
If your solutions are correct, the instructor will give you an additional
exercise to complete during your quiz for credit.
}
\begin{document}
\theForm
\newpage
