...
need to rewrite the question. Submit this form in class on the date of
the Mastery Quiz that immediately follows the date you received a
\(\ast\) mark for this exercise.
\textbf{You may not also attempt this standard on that quiz.}
\end{document}
