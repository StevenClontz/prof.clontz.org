...
Submit this form in class on the Tuesday
that immediately follows the date you received a
\(\ast\) mark for this exercise.
\textbf{If you are submitting a second revision, attach the original revision to your submission.}
\end{document}
